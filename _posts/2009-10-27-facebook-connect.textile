...
{% highlight javascript %} FB.Connect.showFeedDialog(STI.bundle, STI.template, '', STI.general, null, FB.RequireConnect.promptConnect, STI.formComplete, STI.prompt, story);{% endhighlight %}
